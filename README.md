[![Build Status](https://travis-ci.com/github/j-bac/scikit-dimension.svg?token=St4VFQxgQ93UPzzi8TFA&branch=master)](https://travis-ci.com/j-bac/scikit-dimension)
